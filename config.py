...
def base_log_config():
    ...
    lht = logging.handlers.TimedRotatingFileHandler(filename='C:\\Users\Administrator\Desktop\测试资料\项目实战\\autoToutiaoTest\log\\test.log', when='midnight', interval=1,backupCount=2)
    # 4.创建格式化器
